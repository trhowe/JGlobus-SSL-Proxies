...
public class X509Credential {
    ...
    private static Logger logger = Logger.getLogger(X509Credential.class.getCanonicalName());
    ...
    public X509Credential(String proxyFile) throws CredentialException {
        ...
        logger.fine("Loading proxy file: " + proxyFile);
    ...
    try {
        return BouncyCastleUtil.getIdentity(this.certChain);
            ...
            logger.fine("Error getting certificate identity" + e.getMessage());
        return null;
    }
    }
    ...
    public int getPathConstraint() {
        ...
        try {
            ...
            logger.warning("Error retrieving path length: " + e.getMessage());
            pathLength = -1;
        }
        return pathLength;
    }
