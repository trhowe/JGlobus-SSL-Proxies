...
public class BouncyCastleCertProcessingFactoryTest extends TestCase {
    ...
    public void testResctrictedNoProxyCertInfoExt() throws Exception {
        ...
        try {
            factory.createCredential(cred.getCertificateChain(), cred.getPrivateKey(), 512, 60 * 60,
                GSIConstants.GSI_3_RESTRICTED_PROXY, (X509ExtensionSet) null, null);
    ...
    public void testExtensions() throws Exception {
        ...
        GlobusCredential newCred = factory.createCredential(cred.getCertificateChain(), cred.getPrivateKey(), 512,
            60 * 60, GSIConstants.GSI_3_IMPERSONATION_PROXY, extSet, null);
    ...
    private void verifyExtension(X509Certificate cert, String oid, String expectedValue, boolean critical)
        throws Exception {
