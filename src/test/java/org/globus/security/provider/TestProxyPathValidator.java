...
public class TestProxyPathValidator {
    ...
    private void validateChain(X509Certificate[] chainCerts, KeyStore keyStore, CertStore certStore,
        SigningPolicyStore policyStore, X509Certificate expectedIdentity, boolean expectedLimited) throws Exception {
    ...
    private void validateChain(List<? extends Certificate> certList, KeyStore keyStore, CertStore certStore,
        SigningPolicyStore policyStore, X509Certificate expectedIdentity, boolean expectedLimited) throws Exception {

        CertPath certPath = factory.generateCertPath(certList);

        validateChain(certPath, keyStore, certStore, policyStore, expectedIdentity, expectedLimited);
    }

    private void validateChain(CertPath chain, KeyStore keyStore, CertStore certStore, SigningPolicyStore policyStore,
        ...
        X509ProxyCertPathParameters parameters = new X509ProxyCertPathParameters(keyStore, certStore, policyStore,
            false);
        X509ProxyCertPathValidatorResult result = (X509ProxyCertPathValidatorResult) validator.engineValidate(chain,
            parameters);
    ...
    private void validateError(X509Certificate[] certChain, KeyStore keyStore, CertStore certStore,
        SigningPolicyStore policyStore, String error) throws Exception {
        ...
        try {
            X509ProxyCertPathValidatorResult result = (X509ProxyCertPathValidatorResult) validator.engineValidate(
                chain, parameters);
    ...
    private void validateChainWithPolicy(X509Certificate[] chainCerts, KeyStore keyStore, CertStore certStore,
        SigningPolicyStore policyStore, boolean error) throws Exception {

        List<X509Certificate> certList = Arrays.asList(chainCerts);

        CertPath certPath = factory.generateCertPath(certList);

        MockProxyCertPathValidator validator = new MockProxyCertPathValidator(false, false, true);
        X509ProxyCertPathParameters parameters = new X509ProxyCertPathParameters(keyStore, certStore, policyStore,
            false);
        boolean exception = false;
        try {
    ...
    protected KeyStore getKeyStore(X509Certificate[] certificates) throws Exception {
    ...
    public void validateRejectLimitedCheck() throws Exception {
        ...
        MockProxyCertPathValidator validator = new MockProxyCertPathValidator(false, false, false);
        X509ProxyCertPathParameters parameters = new X509ProxyCertPathParameters(keyStore, certStore, policyStore, true);
        ...
        X509ProxyCertPathValidatorResult result = (X509ProxyCertPathValidatorResult) validator.engineValidate(certPath,
            parameters);
    ...
    public void validateGsi3PathGood() throws Exception {
        ...
        X509Certificate[] chain = new X509Certificate[] { goodCertsArr[29], goodCertsArr[7], goodCertsArr[1],
                goodCertsArr[0] };
    ...
    public void validatePathWithRestrictedProxy() throws Exception {
        ...
        X509ProxyCertPathParameters parameters = new X509ProxyCertPathParameters(keyStore, certStore, policyStore,
            false, map);
        X509ProxyCertPathValidatorResult result = (X509ProxyCertPathValidatorResult) validator.engineValidate(path,
            parameters);
    ...
    public void testKeyUsage() throws Exception {
        ...
        validateChain(chain, keyStore, certStore, policyStore, certsArr[1], false);
    }
    ...
    public void testNoBasicConstraintsExtension() throws Exception {
        ...
        TestCertParameters parameters = new TestCertParameters(null, null);
    ...
    public void testCrlsChecks() throws Exception {
        ...
        KeyStore keyStore = getKeyStore(new X509Certificate[] { goodCertsArr[1], goodCertsArr[16], goodCertsArr[25],
                goodCertsArr[21] });
        ...
        validateChain(chain, keyStore, certStore, policyStore, goodCertsArr[22], false);

        // ca1 ca1user2 good chain
        chain = new X509Certificate[] { goodCertsArr[23], goodCertsArr[21] };
        validateChain(chain, keyStore, certStore, policyStore, goodCertsArr[23], false);
        ...
        validateChain(chain, keyStore, certStore, policyStore, goodCertsArr[28], false);
    }
    ...
    public void testSigningPolicy() throws Exception {
        ...
        Map<X500Principal, SigningPolicy> map = parser.parse(reader);

        TestPolicyStore policyStore = new TestPolicyStore(map);
        chain = new X509Certificate[] { goodCertsArr[1], goodCertsArr[0] };
        validateChainWithPolicy(chain, keyStore, certStore, policyStore, false);
    ...
    public class MockProxyCertPathValidator extends X509ProxyCertPathValidator {
        ...
        public MockProxyCertPathValidator(boolean checkCertificateDateValidity_, boolean checkCRLDateValidity_,
    ...
    public class TestPolicyStore implements SigningPolicyStore {
        ...
        public TestPolicyStore(Map<X500Principal, SigningPolicy> policies_) throws InvalidAlgorithmParameterException {
    ...
    public class TestCertParameters implements CertStoreParameters {
        ...
        public TestCertParameters(X509Certificate[] certificates_, X509CRL[] crls_) {
