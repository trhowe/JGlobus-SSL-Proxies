...
public class PureTLSUtil {
    ...
    private static I18n i18n = I18n.getI18n("org.globus.gsi.ptls.errors", PureTLSUtil.class.getClassLoader());

    private static Log logger = LogFactory.getLog(PureTLSUtil.class.getName());
    ...
    /**
     * Converts PureTLS specific X509 certificate object into standard Java X509 certificate object (right now
     * it is using BouncyCastle provider to convert).
     * 
     * @param cert
     ...
     * @return the converted Vector of X509Cert objects. Null if <code>certs</code> array was null.
     * @exception GeneralSecurityException
     *                if conversion fails.
     */
    public static Vector certificateChainToVector(X509Certificate[] certs) throws GeneralSecurityException {
        ...
        try {
            ...
            throw new GeneralSecurityException(i18n.getMessage("conversionFail"), e);
        }
        return v;
    }

    /**
     * Converts a Vector of X509Cert objects into a standard Java X509 certificate array (in the reverse
     * order).
     * 
     * @param chain
    ...
    /**
     * Returns a default certificate checking policy. This is not used as much as the certificate checking was
     * mostly abstracted out from PureTLS code and moved into {@link org.globus.gsi.proxy.ProxyPathValidator
     * ProxyPathValidator}.
     * 
     ...
     * @return the Globus formatted representation of the subject DN.
     * @exception Exception
    ...
    /*
     * import cryptix.provider.rsa.BaseRSAPrivateKey; import cryptix.provider.rsa.BaseRSAPublicKey; import
     * COM.claymoresystems.cert.X509RSAPublicKey;
     * 
     * // Convert Cryptix BaseRSAPrivateKey into RSAPrivateKey new
     * WrappedRSAPrivateKey((BaseRSAPrivateKey)privateKey) // Convert Cryptix BaseRSAPublicKey into
     * X509RSAPublicKey new X509RSAPublicKey(((BaseRSAPublicKey)keyPair.getPublic())),
     */
