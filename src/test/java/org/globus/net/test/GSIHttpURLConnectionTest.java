...
public class GSIHttpURLConnectionTest extends TestCase {
    ...
    /*
     * public void testGET() throws Exception { URL url = new
     * URL("https://localhost:8443/wsrf/services/ContainerRegistryService?wsdl"); GSIHttpURLConnection con =
     * new GSIHttpURLConnection(url);
     * 
     * ((GSIURLConnection)con).setGSSMode(GSIConstants.MODE_SSL);
     * 
     * InputStream in = con.getInputStream(); int ch; StringBuffer buf = new StringBuffer(); while( (ch =
     * in.read()) != -1 ) { System.out.print((char)ch); buf.append((char)ch); }
     * 
     * con.disconnect();
     * 
     ...
     * 
     * 
     * public void testPUT() throws Exception { URL url = new
     * URL("https://localhost:8443/wsrf/services/ContainerRegistryService"); GSIHttpURLConnection con = new
     * GSIHttpURLConnection(url);
     * 
     * ((GSIURLConnection)con).setGSSMode(GSIConstants.MODE_SSL);
     * 
     * String request =
     ...
     * ;
     * 
     * OutputStream out = con.getOutputStream(); out.write(request.getBytes("UTF8")); out.flush();
     * 
     * InputStream in = con.getInputStream(); int ch; StringBuffer buf = new StringBuffer(); while( (ch =
     * in.read()) != -1 ) { System.out.print((char)ch); buf.append((char)ch); }
     * 
