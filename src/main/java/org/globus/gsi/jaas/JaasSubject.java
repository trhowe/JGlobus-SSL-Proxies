...
public abstract class JaasSubject {
    ...
    private static I18n i18n = I18n.getI18n("org.globus.gsi.jaas.JaasErrors", JaasSubject.class.getClassLoader());
    ...
    public static void unsetCurrentSubject(){
        subject = null;
    }
    /**
    ...
    public static synchronized JaasSubject getJaasSubject() {
        if (subject == null) {
            ...
            if (className == null) {
                className = GlobusSubject.class.getCanonicalName();
            }
            try {
                ...
                throw new RuntimeException(i18n.getMessage("loadError", className) + e.getMessage(), e);
            } catch (InstantiationException e) {
                throw new RuntimeException(i18n.getMessage("instanError", className) + e.getMessage(), e);
